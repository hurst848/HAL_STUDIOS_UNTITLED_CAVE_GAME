...
public class sight_Locating_state : StateMachineBehaviour
{
    public float sightRadiusMultiplier = 2.0f;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        monster.GetComponent<sightMonsterController>().viewRadius *= sightRadiusMultiplier;
    }
